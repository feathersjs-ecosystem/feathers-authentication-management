...
- `type`: the name of the action, e. g. `"resendVerifySignup"` to send verification e-mails after the registration of a new user account.

- `user`: the user object, containing information such as user name or e-mail address.

- `notifierOptions`: some additional options. For a full list see
