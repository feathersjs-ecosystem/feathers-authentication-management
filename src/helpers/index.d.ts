...
export { cloneObject, comparePasswords, concatIDAndHash, deconstructId, ensureFieldHasChanged, ensureObjPropsValid, ensureValuesAreStrings, getLongToken, getShortToken, getUserData, hashPassword, isNullsy, notifier, randomBytes, // for testing, make safe from hacking
randomDigits, // for testing, make safe from hacking
sanitizeUserForClient, sanitizeUserForNotifier };
