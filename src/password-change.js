...
var debug = debug_1.default('authLocalMgnt:passwordChange');
function passwordChange(options, identifyUser, oldPassword, password, field, notifierOptions) {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    ensure_values_are_strings_1.default(oldPassword, password);
                ...
                case 2:
                    _e.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, compare_passwords_1.default(oldPassword, user1.password, function () { })];
                case 3:
                    _e.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _e.sent();
                    throw new errors_1.default.BadRequest('Current password is incorrect.', {
                ...
                case 6: return [4 /*yield*/, _b.apply(_a, _c.concat([(_d.password = _e.sent(),
                            _d)]))];
                case 7:
                    user2 = _e.sent();
                    return [4 /*yield*/, notifier_1.default(options.notifier, 'passwordChange', user2, notifierOptions)];
                case 8:
                    user3 = _e.sent();
